...
export default function ComparisonTable({
  ...
  costLabels = defaultCostLabels,
  outcomeLabels = defaultOutcomeLabels,
  filename = 'peo-benefits-comparison.png',
          ...
          <table className="comparison-table">
            ...
            <tbody>
              <tr className="group-row">
                <th scope="row" colSpan={plans.length + 1}>Service coverage</th>
              </tr>
